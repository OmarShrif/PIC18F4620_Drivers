...
# 41 "./ECU_Layer/Keypad/ecu_keypad.h"
Std_ReturnType keypad_initialize(const keypad_t *_keypad);
# 51 "./ECU_Layer/Keypad/ecu_keypad.h"
...
void application_initialize(void)
{
    ...
    ret_init = gpio_port_direction_initialize(GPIO_PORTA_INDEX,0x55);
    ret_init = gpio_port_write_logic(GPIO_PORTA_INDEX,0x55);
    ret_init = gpio_port_read_logic(GPIO_PORTA_INDEX,&portA_logic);
}
